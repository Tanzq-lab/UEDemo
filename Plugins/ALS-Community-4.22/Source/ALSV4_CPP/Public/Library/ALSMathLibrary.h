...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "ALS|Math Utils")
	static FTransform ALSComponentLocalToWorld(const FALSComponentAndTransform& CompAndTransform);
	
	UFUNCTION(BlueprintCallable, Category = "ALS|Math Utils")
	static FTransform ALSComponentWorldToLocal(FALSComponentAndTransform& CompAndTransform);
	...
	UFUNCTION(BlueprintCallable, Category = "ALS|Math Utils")
	static float GetInterpSpeed(float Speed, float DeltaTime);
	...
	static FVector CalculateAxisIndependentLag(
		FVector CurrentLocation, FVector TargetLocation, FRotator CenterRotation, FVector LagSpeeds, float DeltaTime);
};
