...
#define COLLISION_ABILITYOVERLAPPROJECTILE		ECollisionChannel::ECC_GameTraceChannel4
#define COLLISION_PICKUP						ECollisionChannel::ECC_GameTraceChannel5
#define COLLISION_INTERACTABLE					ECollisionChannel::ECC_GameTraceChannel6

DECLARE_LOG_CATEGORY_EXTERN(LogHints, Log, All);
